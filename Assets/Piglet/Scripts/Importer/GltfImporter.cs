				...
				switch (extension)
				{
					case "KHR_materials_basisu":
						...
						Debug.LogWarning(
							...
							"KHR_materials_basisu extension), but the KtxUnity package " +
							"is not installed. Please see \"Installing KtxUnity\" in the " +
					...
					case "KHR_draco_mesh_compression":
						...
						throw new Exception(
							...
							"(i.e. the KHR_draco_mesh_compression extension), but the DracoUnity package " +
							"is not installed. Please see \"Installing DracoUnity\" " +
							"in the Piglet manual for instructions.");
		...
		protected int GetImageIndex(int textureIndex)
		{
			...
			if (texture.Source != null)
			{
				Debug.LogWarning($"{messagePrefix}Failed to load KTX2 texture " +
					"because KtxUnity is not installed. Please see \"Installing " +
					"KtxUnity\" in the Piglet manual. Falling back to PNG/JPG "+
					"version of texture.");
			...
			Debug.LogWarning($"{messagePrefix}Failed to load KTX2 texture " +
				"because KtxUnity is not installed. Please see \"Installing " +
				"KtxUnity\" in the Piglet manual. Falling back to plain "+
				"white texture.");
